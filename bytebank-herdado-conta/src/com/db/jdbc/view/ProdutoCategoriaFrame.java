...
import com.db.jdbc.controller.CategoryController;
import com.db.jdbc.controller.ProductController;
...
public class ProdutoCategoriaFrame extends JFrame {
	...
	public ProdutoCategoriaFrame() throws SQLException {
		...
		comboCategoria.addItem(new Category(0L, "Selecione"));
	...
	private void preencherTabela() throws SQLException {
		...
		try {
			for (Product produto : produtos) {
				modelo.addRow(new Object[] { produto.getName(), produto.getDescription() });
			}
		} catch (Exception e) {
			throw e;
		}
	...
	private List<Category> listarCategoria() throws SQLException {
	...
	private void salvar() throws SQLException {
		if (!textoNome.getText().equals("") && !textoDescricao.getText().equals("")) {
			Product produto = new Product(textoNome.getText(), textoDescricao.getText());
	...
	private List<Product> listarProduto() throws SQLException {
